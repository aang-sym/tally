...
export interface WatchlistApiInterface {
  ...
  ): Promise<runtime.ApiResponse<ApiWatchlistGet200Response>>;
  ...
  apiWatchlistGet(
    requestParameters: ApiWatchlistGetRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistGet200Response>;
   ...
   * @memberof WatchlistApiInterface
   */
  apiWatchlistStatsGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistStatsGet200Response>>;
  ...
  apiWatchlistStatsGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistStatsGet200Response>;
   ...
   * @memberof WatchlistApiInterface
   */
  apiWatchlistTmdbIdProgressPutRaw(
    requestParameters: ApiWatchlistTmdbIdProgressPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistUserShowIdStatusPut200Response>>;
  ...
  apiWatchlistTmdbIdProgressPut(
    requestParameters: ApiWatchlistTmdbIdProgressPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistUserShowIdStatusPut200Response>;
   ...
   * @memberof WatchlistApiInterface
   */
  apiWatchlistUserShowIdProviderPutRaw(
    requestParameters: ApiWatchlistUserShowIdProviderPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
   ...
   */
  apiWatchlistUserShowIdProviderPut(
    requestParameters: ApiWatchlistUserShowIdProviderPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Provider>;
   ...
   * @memberof WatchlistApiInterface
   */
  apiWatchlistUserShowIdRatingPutRaw(
    requestParameters: ApiWatchlistUserShowIdRatingPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistUserShowIdStatusPut200Response>>;
   ...
   * Rate a user show
   */
  apiWatchlistUserShowIdRatingPut(
    requestParameters: ApiWatchlistUserShowIdRatingPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistUserShowIdStatusPut200Response>;
   ...
   * @memberof WatchlistApiInterface
   */
  apiWatchlistUserShowIdStatusPutRaw(
    requestParameters: ApiWatchlistUserShowIdStatusPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistUserShowIdStatusPut200Response>>;
   ...
   */
  apiWatchlistUserShowIdStatusPut(
    requestParameters: ApiWatchlistUserShowIdStatusPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistUserShowIdStatusPut200Response>;
}
...
export class WatchlistApi extends runtime.BaseAPI implements WatchlistApiInterface {
  ...
  async apiWatchlistGetRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ApiWatchlistGet200ResponseFromJSON(jsonValue)
    );
  }
  ...
  async apiWatchlistStatsGetRaw(
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ApiWatchlistStatsGet200ResponseFromJSON(jsonValue)
    );
  }
   ...
   * Update progress for a TMDB show id
   */
  async apiWatchlistTmdbIdProgressPutRaw(
    requestParameters: ApiWatchlistTmdbIdProgressPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistUserShowIdStatusPut200Response>> {
    ...
    urlPath = urlPath.replace(
      `{${'tmdbId'}}`,
      encodeURIComponent(String(requestParameters['tmdbId']))
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ApiWatchlistUserShowIdStatusPut200ResponseFromJSON(jsonValue)
    );
  }
   ...
   * Set selected streaming provider for a user_show
   */
  async apiWatchlistUserShowIdProviderPutRaw(
    requestParameters: ApiWatchlistUserShowIdProviderPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Provider>> {
    ...
    urlPath = urlPath.replace(
      `{${'userShowId'}}`,
      encodeURIComponent(String(requestParameters['userShowId']))
    );
   ...
   * Set selected streaming provider for a user_show
   */
  async apiWatchlistUserShowIdProviderPut(
    requestParameters: ApiWatchlistUserShowIdProviderPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Provider> {
    const response = await this.apiWatchlistUserShowIdProviderPutRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * Rate a user show
   */
  async apiWatchlistUserShowIdRatingPutRaw(
    requestParameters: ApiWatchlistUserShowIdRatingPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistUserShowIdStatusPut200Response>> {
    if (requestParameters['userShowId'] == null) {
   ...
   * Rate a user show
   */
  async apiWatchlistUserShowIdRatingPut(
    requestParameters: ApiWatchlistUserShowIdRatingPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistUserShowIdStatusPut200Response> {
    const response = await this.apiWatchlistUserShowIdRatingPutRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   * Update user show status
   */
  async apiWatchlistUserShowIdStatusPutRaw(
    requestParameters: ApiWatchlistUserShowIdStatusPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ApiWatchlistUserShowIdStatusPut200Response>> {
    if (requestParameters['userShowId'] == null) {
   ...
   * Update user show status
   */
  async apiWatchlistUserShowIdStatusPut(
    requestParameters: ApiWatchlistUserShowIdStatusPutRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ApiWatchlistUserShowIdStatusPut200Response> {
    const response = await this.apiWatchlistUserShowIdStatusPutRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
