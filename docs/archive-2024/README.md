# Archived Documentation (2024)

This directory contains historical planning documents and fix guides from 2024 development, archived during the 2025-11-17 codebase cleanup.
...
If you need to reference a specific fix or decision, check here first before re-implementing.
