...
async function testRLSFix() {
  ...
  try {
    ...
    const testJWT =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJjYTk3YWViOC0yNTBhLTQ2MjAtYWU0Ny01N2RkZWY3ZmU2MjkiLCJlbWFpbCI6InRlc3RmaW5hbEBleGFtcGxlLmNvbSIsImRpc3BsYXlOYW1lIjoiRmluYWwgVGVzdCIsImlhdCI6MTc1NzAzNjEyNiwiZXhwIjoxNzU3NjQwOTI2fQ.1Ke5_vB2HpbGDEKA4EB7RqPVgj_PLoOqUBbGo1YIaUc';
